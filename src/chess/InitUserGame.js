    ...
    <div>
      {gameStart ? (
        ...
        <div className="setup-wrapper">
          ...
          <p>
            Select what color you wish to play as and the difficulty of the
            computer. The computer algorithm will search deeper into the
            analysis tree at higher difficulties!
          </p>
        </div>
      )}
    </div>
